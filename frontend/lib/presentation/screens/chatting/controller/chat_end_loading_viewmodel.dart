...
class ChatEndLoadingViewModel extends GetxController {
  ...
  final mindset;
  final conversationId; // ChatRoom ID
  final finalRejectionScore; // final rejection score
  final finalAffinityScore; // final affinity score
  final unachievedQuests; // unachieved quests
